...
import {Segment, Header, List, Accordion, Icon, Divider, Message } from 'semantic-ui-react';
        ...
        return (
            <Segment>
                ...
                <Accordion fluid styled>
                    <Accordion.Title active={activeAbstract} onClick={this.handleAbstract}>
                        Abstract
                        <Icon name="dropdown" />
                    </Accordion.Title>
                ...
                { contents &&
                <Accordion fluid styled>
                    <Accordion.Title active={activeContent} onClick={this.handleContent}>
                        Content
                        <Icon name="dropdown" />
                    </Accordion.Title>
